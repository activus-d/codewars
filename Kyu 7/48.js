...
function barista(coffees){
    //get cleaning and waiting time for last brew
    //create an array to copy and push last waiting time and cleaning time
    let newArray = [...coffees]//
    coffees = coffees.sort( (a,b) => a - b )
    coffees.forEach( (e,i,a) => i === 0 ? newArray[0] = e : newArray[i] = e + 2 + newArray[i - 1] )
